 ...
 *
 */
public class WorkOnlineAuthorityInterceptor extends HandlerInterceptorAdapter {

    private Logger log= LoggerFactory.getLogger("WorkOnlineAuthorityInterceptor");
    ...
    protected Logger logger = LoggerFactory.getLogger(WorkOnlineAuthorityInterceptor.class);
    private TokenProvider tokenProvider;
    private UserContext userContext;
    private NamedThreadLocal<Long> startTimeThreadLocal = new NamedThreadLocal<Long>("StopWatch-StartTime");

    public WorkOnlineAuthorityInterceptor(TokenProvider tokenProvider, RedisCache redisCache) {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        String jwt = request.getHeader(TokenProvider.AUTHORIZATION_WORKONLINE);
        ...
        //校验jwt是否合法
        if (!jwt.startsWith("BearerWorkOnline")) {
            //格式不对
            log.info("格式不对");
