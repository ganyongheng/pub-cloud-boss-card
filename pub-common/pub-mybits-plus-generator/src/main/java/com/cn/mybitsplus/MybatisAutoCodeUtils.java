...
public class MybatisAutoCodeUtils {
    ...
    public static void main(String[] args) {
        ...
        String[] tables = new String[]{
                "online_resume","online_user","online_work","online_work_user"
        };
        //数据库连接url
        ...
        String url = "jdbc:mysql://10.1.1.120:3306/sass_work?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&serverTimezone=Asia/Shanghai";
