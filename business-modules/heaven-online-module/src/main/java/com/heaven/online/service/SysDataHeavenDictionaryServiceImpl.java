...
import rabb.heaven.entity.SysDataHeavenDictionaryDo;
import rabb.heaven.mapper.SysDataHeavenDictionaryMapper;
 ...
 */
@Service
public class SysDataHeavenDictionaryServiceImpl extends ServiceImpl<SysDataHeavenDictionaryMapper, SysDataHeavenDictionaryDo> implements IService<SysDataHeavenDictionaryDo> {


    private static Log log = LogFactory.getLog(SysDataHeavenDictionaryServiceImpl.class);
        ...
        if(cacheMap==null){
            synchronized ("cacheMap"){
                if(cacheMap==null){
                    ...
                    QueryWrapper<SysDataHeavenDictionaryDo> qw=new QueryWrapper<>();
                    qw.eq("status",Constant.status.online);
                    qw.orderByAsc("id");
                    List<SysDataHeavenDictionaryDo> list = list(qw);
                    for (SysDataHeavenDictionaryDo SysDataHeavenDictionaryDo : list) {
                        String paramName = SysDataHeavenDictionaryDo.getParamName();
                        String paramValue = SysDataHeavenDictionaryDo.getParamValue();
                        String paramKey = SysDataHeavenDictionaryDo.getParamKey();
